...
Milestone 2 adds the authenticated API boundary and reference-only event outbox.
It still does not implement extension capture, screenshot upload, queue
consumption, AI processing, or dashboard product queries.
